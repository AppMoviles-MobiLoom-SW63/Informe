...
| Nombre del estudiante              | Descripción del objetivo                                                                                                                                                                                                                | Fecha de inicio     | Fecha de cumplimiento esperada   | Specific (Específico)                                                                                                                                                                                     | Measurable (Medible)                                                                                                                                                                                                                                                | Ambitious (Ambicioso)                                                                                                                                                                                              | Relevant (Relevante)                                                                                                                                                                                | Time-bound (Tiempo Límite)                                                                                                                                          |
|:-----------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------|:---------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Criollo De La Cruz, Diego Anderson | Definirá el Problem Statement para MobiLoom, estableciendo las bases para el desarrollo del proyecto.                                                                                                                                     | 2024-08-12 00:00:00 | 2024-08-19 00:00:00              | Definir el Problem Statement para MobiLoom, estableciendo con claridad el desafío que el proyecto debe resolver.                                                                                         | El objetivo se medirá mediante la claridad y precisión del Problem Statement definido, así como su aprobación por el equipo de trabajo.                                                                     | Este objetivo reta al estudiante a identificar y articular de manera precisa el desafío central del proyecto, lo cual es crucial para el éxito de las etapas subsiguientes.                                   | Está alineado con la estrategia de MobiLoom de resolver problemas clave para el usuario, lo cual es esencial para asegurar que el producto final sea relevante y útil.                                    | Este objetivo deberá cumplirse en la primera semana del proyecto para garantizar que todas las actividades subsecuentes tengan una base sólida.                                                           |
| Herrera González, Luis Eduardo     | Realizará una investigación de competidores en el mercado de soluciones móviles para movilidad urbana, con el fin de identificar brechas y oportunidades para MobiLoom.                                                                  | 2024-08-12 00:00:00 | 2024-08-26 00:00:00              | Realizar una investigación exhaustiva de los competidores en el mercado de soluciones móviles para movilidad urbana, identificando brechas y oportunidades que MobiLoom puede aprovechar.                   | Se medirá mediante la identificación de al menos tres brechas u oportunidades que no estén siendo abordadas por los competidores actuales, con el objetivo de posicionar a MobiLoom de manera competitiva. | El objetivo desafía al estudiante a identificar oportunidades en un mercado saturado, requiriendo un análisis profundo y estratégico para asegurar que MobiLoom ofrezca un valor único y diferenciado.      | Este objetivo es fundamental para asegurar que MobiLoom se diferencie en el mercado, ofreciendo soluciones que realmente agreguen valor y resuelvan problemas no abordados por los competidores actuales. | La investigación y recopilación de evidencias deben estar completadas en las primeras dos semanas para permitir la definición de la estrategia de mercado de MobiLoom.                                     |
| Morales Calderón, Hernan Emilio    | Analizará las entrevistas para identificar y definir las necesidades principales de los usuarios finales, asegurando que el producto cumpla con sus expectativas.                                                                       | 2024-08-12 00:00:00 | 2024-08-26 00:00:00              | Analizar las entrevistas para identificar y definir las necesidades principales de los usuarios finales, asegurando que el producto cumpla con sus expectativas.                                           | Se evaluará mediante la precisión y utilidad de las fichas de usuario generadas, así como la validación de estas fichas y la propuesta de valor por parte del equipo directivo.                             | El objetivo exige una profunda comprensión del usuario y del mercado, retando al estudiante a proponer una oferta que destaque en un mercado altamente competitivo.                                        | Alineado con la misión de MobiLoom, este objetivo es crucial para garantizar que las soluciones desarrolladas realmente respondan a las necesidades de los usuarios y se diferencien en el mercado.       | Este objetivo deberá cumplirse dentro de las primeras dos semanas del proyecto para asegurar su relevancia y aplicabilidad.                                                                               |
| Valle Zuta, Abel Andrés            | Identificará y definirá las User Stories alineadas con el alcance del producto. Demostrará pensamiento innovador al proponer mejoras y comunicará eficazmente las ideas desarrolladas.                                                  | 2024-08-12 00:00:00 | 2024-08-27 00:00:00              | Identificar y definir las User Stories necesarias para el desarrollo de MobiLoom, asegurando que estén alineadas con el alcance del producto y las necesidades del usuario.                               | El cumplimiento se medirá mediante la cantidad de User Stories definidas y su alineación con el roadmap del producto. El KPI será la aprobación de estas historias por el equipo de desarrollo.             | Este objetivo reta al estudiante a pensar de manera integral y anticipada, creando User Stories que no solo respondan a las necesidades actuales, sino que también proyecten la evolución futura del producto. | Este objetivo es vital para asegurar que el desarrollo de MobiLoom siga una dirección estratégica clara y enfocada en las necesidades del usuario final.                                                  | Las User Stories deben estar completamente definidas y aprobadas dentro de las primeras tres semanas del proyecto.                                                                                       |
