...
Para acceder al video de las entrevistas de validación, haga click en la ([URL](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202219639_upc_edu_pe/EaT7rxVI5YlAu4G-I2h8yAEB3MQ7vXktHa-x6-NqDljtZQ?e=yH7cvy&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D))
...
1. ¿Cómo describiría su impresión general después de ver la aplicación de DiligenceTech?
2. ¿Qué aspectos de la aplicación le parecieron más útiles para su trabajo diario?
3. ¿Hubo alguna funcionalidad específica que le sorprendiera o impresionara?
4. ¿Notó alguna dificultad potencial al navegar por la aplicación?
5. ¿Qué tan fácil considera que sería acceder a los análisis de datos o a los documentos del proyecto?
6. ¿Considera que la aplicación podría mejorar la eficiencia en la realización de due diligence? ¿Por qué?
7. ¿Qué elementos de la interfaz de usuario le parecen más intuitivos?
8. ¿Qué elementos de la interfaz de usuario cree que podrían mejorarse?
9. ¿La velocidad de procesamiento de datos mostrada le parece adecuada para sus necesidades?
10. ¿Cómo calificaría la precisión de los análisis financieros presentados?
11. ¿Cree que la aplicación facilita la colaboración con otros contadores o miembros del equipo?
12. ¿La aplicación cubre todas sus necesidades actuales de Due Diligence? Si no, ¿qué le falta?
13. ¿Qué características adicionales le gustaría ver en futuras versiones de la aplicación?
14. ¿Considera que la información presentada en los informes es clara y comprensible?
15. ¿Qué tan útil le parece la automatización de las funciones para su trabajo?
16. ¿La aplicación ofrece suficientes recursos y soporte para resolver dudas o problemas técnicos?
17. ¿Cómo calificaría el diseño visual de la aplicación?
18. ¿Recomendaría esta aplicación a otros contadores? ¿Por qué?
19. ¿Qué mejoras sugiere para incrementar la usabilidad de la aplicación?
20. ¿Algún comentario adicional sobre su experiencia con DiligenceTech?
...
1. ¿Cuál fue su impresión inicial después de ver la aplicación de DiligenceTech?
2. ¿Qué aspectos de la aplicación le parecieron más valiosos para sus decisiones de inversión?
3. ¿Hubo alguna característica que le resultara especialmente innovadora o útil?
4. ¿Le pareció fácil navegar por la aplicación y encontrar la información que necesitaba?
5. ¿Qué tan bien considera que la aplicación ayuda a evaluar el riesgo financiero?
6. ¿Cómo describiría la calidad y precisión de los informes generados por la aplicación?
7. ¿Qué tan rápido cree que podría obtener la información necesaria para sus evaluaciones?
8. ¿La aplicación facilita la comprensión de los datos financieros para la toma de decisiones?
9. ¿Qué elementos de la aplicación le resultaron más intuitivos?
10. ¿Qué aspectos de la interfaz de usuario cree que podrían mejorarse?
11. ¿Considera que la aplicación podría mejorar la eficiencia en la realización de due diligence? ¿Por qué?
12. ¿Le parece útil la función de automatización para sus análisis financieros?
13. ¿En qué medida considera que la aplicación permitiría colaborar con otros inversores o asesores financieros?
14. ¿Qué funcionalidades adicionales le gustaría ver en futuras versiones de la aplicación?
15. ¿La aplicación cubre todas sus necesidades actuales de due diligence? Si no, ¿qué le falta?
16. ¿Cómo calificaría el soporte y los recursos disponibles para resolver dudas o problemas técnicos?
17. ¿Qué tan clara y comprensible encuentra la presentación de los datos en la aplicación?
18. ¿Recomendaría esta aplicación a otros inversores? ¿Por qué?
19. ¿Qué mejoras sugiere para incrementar la usabilidad de la aplicación?
20. ¿Algún comentario adicional sobre su experiencia con DiligenceTech?
...
<br>
 ...
 <div align="center">
    <img src="https://raw.githubusercontent.com/AppMoviles-MobiLoom-SW63/Informe/main/Resources/cap5.3/videoatp.PNG">
 </div>
...
## Validation Interviews
  ...
  <div align="center">
    <img src="https://raw.githubusercontent.com/AppMoviles-MobiLoom-SW63/Informe/main/Resources/cap5.3/videovi.PNG">
 </div>
